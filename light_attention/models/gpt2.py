...
class LightGPT2Attention(nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None):
        ...
        # Happens between dropout and matmul
...
class LightGPT2Model(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.h = nn.ModuleList([LightGPT2Block(config, layer_idx=i) for i in range(config.num_hidden_layers)])
...
class LightGPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.transformer = LightGPT2Model(config)
